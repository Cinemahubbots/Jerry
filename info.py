...
BOT_TOKEN = '6698489150:AAEpk3nMlN-W4ceNO_OHulzJcPlPafbO3ws'
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://JERRY:JERRY@cluster0.no8aogg.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# FSUB
auth_channel = environ.get('AUTH_CHANNEL','--1002151989500')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
# Set to False inside the bracket if you don't want to use Request Channel else set it to Channel ID
REQ_CHANNEL = environ.get("REQ_CHANNEL",' -1002243004705')
